...
/*  лининговый центр
 лининговый центр
1. –еализовать метод cleanAllApartaments.
ƒл¤ каждого объекта из apartaments:
2. ƒл¤ однокомнатных квартир (Apt1Room) вызвать метод clean1Room.
т.е. если объект типа Apt1Room, то вызвать у него метод clean1Room.
3. ƒл¤ двухкомнатных квартир (Apt2Room) вызвать метод clean2Rooms
т.е. если объект типа Apt2Room, то вызвать у него метод clean2Rooms.
4. ƒл¤ трехкомнатных квартир (Apt3Room) вызвать метод clean3Rooms
